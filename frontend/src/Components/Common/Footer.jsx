        ...
        <footer className="border-t py-12 ">
            <div className="container   mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4  lg:px-0">
                <div>
                    ...
                    <form className="flex">
                        <input
                            ...
                            required
                        />
                        <button type="submit" className='bg-black text-white px-6 text-sm py-3 rounded-r-md hover:bg-gray-800 transition-all '
                        >Subscribe</button>
                    </form>
                </div>
                ...
                <div>
                    ...
                    <ul className='space-y-2 text-gray-600'>
                        <li>
                            <Link to="##" className='hover:text-gray-500 transition-colors' >Men's Product</Link>
                        </li>
                        <li>
                            <Link to="##" className='hover:text-gray-500 transition-colors' >Womens's Product</Link>
                        </li>
                        <li>
                            <Link to="##" className='hover:text-gray-500 transition-colors' >Perfumes</Link>
                        </li>

                        <li>
                            <Link to="##" className='hover:text-gray-500 transition-colors' >Slippers</Link>
                        </li>
                        <li>
                            <Link to="##" className='hover:text-gray-500 transition-colors' >Leather Products</Link>
                        </li>
            ...
            <div className='container mx-auto mt-12 px-4 lg:px-0 border-t border-gray-200 pt-6'>
                <p className='text-gray-500 text-sm tracking-tighter text-center'>
                    ©2022-2026, M N M A General Trading - L.L.C- S.P.C,  All rights reserved.
                </p>
            </div>
